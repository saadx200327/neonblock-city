...
- Delivery Board: a hideable `Shift+R` panel and mobile Deliver button adds repeatable Food Hop, Block Runner, and District Loop contracts that reward walking, driving, mixed city travel, quick saves, page-hide report persistence, and copyable QA reports.
- City Events: a hideable `Shift+E` panel and mobile Events button adds repeatable street-cleanup, traffic-test, and market-scan activities tied to movement, driving, streaming, rewards, quick saves, and copyable event QA reports.
...
- Vehicles: enter or exit nearby cars with Interact; vehicles have gas, higher movement speed, braking support, local garage ownership, emergency field repair/tow, roadside recovery, checkpoint return, civic clean-driving rewards, delivery contracts, city-event traffic tests, map-assisted hub recovery, district scouting, quest-log guidance, and can be refueled with cash.
...
- Objective polish adds a persistent City Objectives panel, daily movement/driving/property goals, nearby opportunity hints, and safe reward saving through the existing runtime API.
...
- City Events polish adds a `Shift+E` repeatable-event panel, mobile Events button, movement/driving/streaming event goals, claimable rewards, quick save, page-hide report persistence, and copyable event QA report.
- Delivery Board polish adds a `Shift+R` repeatable-contract panel, mobile Deliver button, walking/driving/mixed-route progress, claimable cash/XP rewards, quick save, page-hide report persistence, and copyable delivery QA report.
...
- `neonblock-city-events-polish.js` - City Events panel, mobile Events button, repeatable movement/driving/streaming event goals, rewards, quick save, and copyable event QA reports.
- `neonblock-delivery-board-polish.js` - Delivery Board panel, mobile Deliver button, walking/driving/mixed-route contracts, claimable cash/XP rewards, quick save, and copyable delivery QA report.
