...
- Vehicles: enter or exit nearby cars with Interact; vehicles have gas, higher movement speed, braking support, local garage ownership, emergency field repair/tow, roadside recovery, checkpoint return, map-assisted hub recovery, district scouting, quest-log guidance, and can be refueled with cash.
