...
- Shift: sprint or faster driving
- Space: jump
...
`firebase-backend.js` is intentionally inert by default. It does not include Firebase keys and does not write to any external project unless a future integration defines compatible cloud save functions before `app.js` runs.
