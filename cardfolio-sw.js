const CACHE='cardfolio-shell-v2';
const SHELL=['/','/index.html','/cardfolio.css','/cardfolio-app.js','/cardfolio-app-2.js','/cardfolio-app-3.js','/cardfolio-app-4.js','/cardfolio-fixes.js','/cardfolio-manifest.webmanifest','/cardfolio-icon.svg'];
